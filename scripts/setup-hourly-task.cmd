@echo off
REM One-click: create Windows scheduled task to run ingest every hour.
...
schtasks /create /tn "%TASK_NAME%" /tr "\"%RUN_SCRIPT%\"" /sc hourly /st 00:00 /f
if %ERRORLEVEL% equ 0 (
  echo Task "%TASK_NAME%" created. It will run every hour.
