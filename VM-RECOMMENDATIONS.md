...
3. **Cron:** Run the ingest every 3 hours, e.g.  
...
Once this is set up, **your PC can be off**; the VM runs ingest + think + push every 3 hours and can serve the dashboard 24/7.
